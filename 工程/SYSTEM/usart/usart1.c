...
char RxCounter,Usart1RecBuf[64] = {0};//串口1接收数据缓存
char bUsart1RecFlag = 0;   //串口1收到数据标志位
extern u8 receive;
...
void USART1_IRQHandler(void)                	//串口1中断服务程序
{
		...
		if(Usart1RecBuf[RxCounter-16]=='+'&&Usart1RecBuf[RxCounter-15]=='I'&&Usart1RecBuf[RxCounter-14]=='P'&&Usart1RecBuf[RxCounter-13]=='D')
		{
				bUsart1RecFlag = 1;
		}
} 
